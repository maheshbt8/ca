	<!-- Start Sidebar Modal -->
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						<div class="modal-header">
							...
							<h2 class="modal-title" id="myModalLabel2"><a href="index.html"><img src="<?php echo base_url()?>assets/front-end/img/logo.png" alt="logo"></a></h2>
						</div>
        ...
        <section class="page-title-banner">
            ...
            <div class="shape1"><img src="<?php echo base_url()?>assets/front-end/img/shape1.png" alt="img"></div>
			<div class="shape2"><img src="<?php echo base_url()?>assets/front-end/img/shape2.png" alt="img"></div>
			<div class="shape3"><img src="<?php echo base_url()?>assets/front-end/img/shape3.png" alt="img"></div>
			<div class="shape6"><img src="<?php echo base_url()?>assets/front-end/img/shape6.png" alt="img"></div>
			<div class="shape8 rotateme"><img src="<?php echo base_url()?>assets/front-end/img/shape8.svg" alt="shape"></div>
            <div class="shape9"><img src="<?php echo base_url()?>assets/front-end/img/shape9.svg" alt="shape"></div>
                ...
                <div class="row h-100 justify-content-center align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="signup-image">
                            <img src="<?php echo base_url()?>assets/front-end/img/marketing.png" alt="image">
                        </div>
